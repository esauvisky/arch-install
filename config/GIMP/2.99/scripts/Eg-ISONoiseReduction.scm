...
;
; Using a plugin like dcamnoise2 from http://www.hphsite.de/dcamnoise/ or
; greycstoration from http://www.greyc.ensicaen.fr/~dtschump/greycstoration/
...
;
		(cond
			...
			((= InFlatten FALSE)
				(begin
					(gimp-drawable-set-name NoiseLayer "Noisefree")
