...
; The script is located in menu "<Image>/Filters/Paul Sherman's/Edges/Translucent Border"
...
(script-fu-menu-register "210-trans-border" "<Image>/Filters/Paul Sherman's/Edges")
